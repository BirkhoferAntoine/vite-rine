...
const CircuitLineLosange = forwardRef((props, ref) => {
    ...
    return (
        <Box
            ...
            className={
                'circuit-line-losange-container circuit-line-losange filter-highlight pseudo-element-gradient shadow-highlight ' +
                addClassName
            }
        >
            <Box
                sx={sxStyles.losangeOut}
                className={
                    'circuit-line-losange-out circuit-line-losange filter-highlight pseudo-element-gradient'
                }
            >
                <Box
                    sx={sxStyles.losangeCenter}
                    className={
                        'circuit-line-losange-center circuit-line-losange pseudo-element-gradient'
                    }
                >
                    {
                        children
