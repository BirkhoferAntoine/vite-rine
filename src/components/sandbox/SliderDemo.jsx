        ...
        return (
            <Box className={'work-slider-container filter-highlight shadow-highlight backdrop-filter-blur'}>
                <Box className={'work-slider'}>
                    <Box ref={this.sliderRef} className={'work-slider-wrapper filter-blur'}>
                        <Box ref={this.slidesRef} className={'work-slider-background'}/> {/*sx={{position: 'absolute', width: '100%', height:'100%', border: '4px solid transparent', background:'url("src/assets/planet-581239_1280.jpg")'}}*/}
