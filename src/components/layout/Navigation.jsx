        ...
        <>
            <AppBar position={'fixed'} sx={sxStyles.header}>
                <Toolbar sx={sxStyles.toolbar}>
                    ...
                    >
                        <Logo image={false} />{' '}
                        {/*'src/assets/abrkah_transparent_background_with_a_beautifull_logo_for_a_webs_13f86818-dc0e-4d82-8029-ea22dbcfe68f.png'*/}
                        <Box
                            flexGrow={1}
                        ...
                        >
                            ...
                            <Typography
                                className={
                                    'text-outline-yellow filter-highlight'
                                }
                            >
                                Paris
                            </Typography>
