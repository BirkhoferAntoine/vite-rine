    ...
    return (
        <section id={'work-section'}>
            ...
            <Container className={'work-container'}>
                <Box className={'bg-design-container-center'}></Box>
                <Grid container spacing={2}>
                    <Grid>
                        <Item maxPad={'12px'} maxBorder={'8px'}>
                    ...
                    <Grid>
                        <Item maxPad={'12px'} maxBorder={'8px'}>
                            <img
                                src="src/assets/VIGNETTE-PHOTOBOOTH-CLASSIC-845x684-removebg-preview.png"
                                alt=""
                            />
                        </Item>
                    </Grid>
                ...
                <Box
                    className={
                        'work-text-container text-container shadow-highlight'
                    }
                >
                    <Typography
                        className={'work-text typography-highlight'}
                        align={'justify'}
                    >
